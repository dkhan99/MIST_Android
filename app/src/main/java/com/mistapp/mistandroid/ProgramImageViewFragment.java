...
public class ProgramImageViewFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView image = (ImageView) view.findViewById(R.id.image_friday);
        String dayToShow = "daturday";
